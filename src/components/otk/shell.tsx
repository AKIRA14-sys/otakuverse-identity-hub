...
const navItems = [
  { to: "/", label: "Home", shape: "rounded-md" },
  { to: "/discover", label: "Discover", shape: "rounded-md" },
  { to: "/library", label: "Library", shape: "rounded-full" },
  { to: "/profile", label: "Profile", shape: "rounded-md" },
] as const;
